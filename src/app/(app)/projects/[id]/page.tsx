...
export default async function ProjectDetailsPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [project, missions, materials, employees, session] = await Promise.all([
  ...
  return <ProjectDetailsView project={project} missions={missions} materials={materials} workers={workers} canManage={canManage} />;
}
